...
import { AppProvider } from "./contexts/AppContext"; // ⬅️ Add this import
import "./i18n/config";
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route 
                path="/dashboard" 
                element={<ProtectedRoute requireAgency><Dashboard /></ProtectedRoute>}
              />
              <Route 
                path="/dashboard/properties" 
                element={<ProtectedRoute requireAgency><DashboardProperties /></ProtectedRoute>}
              />
              <Route 
                path="/dashboard/properties/add" 
                element={<ProtectedRoute requireAgency><AddProperty /></ProtectedRoute>}
              />
              <Route 
                path="/dashboard/properties/edit/:id" 
                element={<ProtectedRoute requireAgency><EditProperty /></ProtectedRoute>}
              />
